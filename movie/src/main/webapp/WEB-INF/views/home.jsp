...
<head>
    ...
    <link rel="stylesheet" href="../../resources/assets/js/rs-plugin/css/settings.css">

    <link rel="stylesheet" href="../../resources/assets/css/styles.css">


    <script type="text/javascript" src="../../resources/assets/js/modernizr.custom.32033.js"></script>
...
<body>
    ...
    <div class="pre-loader">
        <div class="load-con">
            <img src="../../resources/assets/img/freeze/logo.png" class="animated fadeInDown" alt="">
            <div class="spinner">
                ...
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="home.html">
                            <img src="../../resources/assets/img/freeze/logo.png" alt="" class="logo">
                        </a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li><a href="#about">공지사항</a>
                            </li>
                            <li><a href="#features">features</a>
                            </li>
                            <li><a href="#reviews">영화순위</a>
                            </li>
                            <li><a href="#screens">영화리뷰</a>
                            </li>
                            <li><a href="#demo">QnA</a>
                            </li>
                            <li><a class="getApp" href="#getApp">LOG IN</a>
                            </li>
                            <li><a class="getApp" href="#support">SIGN UP</a>
                            </li>
                        </ul>
                    </div>
                    <!-- /.navbar-collapse -->
            ...
            <div class="tp-banner" >
                <ul>
                    ...
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                        <!-- MAIN IMAGE -->
                        <img src="../../resources/assets/img/transparent.png"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                        <!-- LAYERS -->
                        <!-- LAYER NR. 1 -->
                        <div class="tp-caption lfl fadeout hidden-xs"
                            ...
                            <img src="../../resources/assets/img/freeze/Slides/hand-freeze.png" alt="">
                        </div>
                        ...
                        <div class="tp-caption lfl fadeout visible-xs"
                            ...
                            data-start="700"
                            data-easing="Power4.easeOut">
                            <img src="../../resources/assets/img/freeze/iphone-freeze.png" alt="">
                        </div>
                    ...
                    <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                        ...
                        <div class="tp-caption lfb fadeout hidden-xs"
                            ...
                            data-start="700"
                            data-easing="Power4.easeOut">
                            <img src="../../resources/assets/img/freeze/Slides/freeze-slide2.png" alt="">
                        </div>
                    ...
                    <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                        ...
                        data-customout="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0.75;scaleY:0.75;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;"
                            ...
                            data-start="700"
                            data-easing="Power4.easeOut">
                            <img src="../../resources/assets/img/freeze/Slides/family-freeze.png" alt="">
                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4" >
                        <img src="../../resources/assets/img/freeze/iphone-freeze.png" class="img-responsive scrollpoint sp-effect5" alt="">
                    </div>
        ...
        <section id="screens">
            <div class="container">
                ...
                <div class="slider filtering scrollpoint sp-effect5" >
                    <div class="one">
                        <img src="../../resources/assets/img/freeze/screens/profile.jpg" alt="">
                        <h4>Profile Page</h4>
                    </div>
                    <div class="two">
                        <img src="../../resources/assets/img/freeze/screens/menu.jpg" alt="">
                        <h4>Toggel Menu</h4>
                    </div>
                    <div class="three">
                        <img src="../../resources/assets/img/freeze/screens/weather.jpg" alt="">
                        <h4>Weather Forcast</h4>
                    </div>
                    <div class="one">
                        <img src="../../resources/assets/img/freeze/screens/signup.jpg" alt="">
                        <h4>Sign Up</h4>
                    </div>
                    <div class="one">
                        <img src="../../resources/assets/img/freeze/screens/calendar.jpg" alt="">
                        <h4>Event Calendar</h4>
                    </div>
                    <div class="two">
                        <img src="../../resources/assets/img/freeze/screens/options.jpg" alt="">
                        <h4>Some Options</h4>
                    </div>
                    <div class="three">
                        <img src="../../resources/assets/img/freeze/screens/sales.jpg" alt="">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="hanging-phone scrollpoint sp-effect2 hidden-xs">
                            <img src="../../resources/assets/img/freeze/freeze-angled2.png" alt="">
                        </div>
                        <div class="platforms">
    ...
    <script src="../../resources/assets/js/placeholdem.min.js"></script>
    <script src="../../resources/assets/js/rs-plugin/js/jquery.themepunch.plugins.min.js"></script>
    <script src="../../resources/assets/js/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
